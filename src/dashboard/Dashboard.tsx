    ...
    <div className="min-h-screen bg-gray-50 max-w-sm mx-auto relative">
      ...
      <div className="bg-white px-4 py-4 flex items-center justify-between">
        <div className="flex items-center space-x-2">
          ...
          <div className="bg-lime-400 text-black text-xs font-bold px-2 py-1 rounded">
            Plus
          </div>
            ...
            <div className="flex-1">
              <div className="mb-3">
                ...
                <div className="flex items-center justify-between">
                  <div className="text-xs text-gray-500 truncate mr-2">
                    XLTMy69uUrDzWBa9JX1xq***
                  </div>
                  <button
                    onClick={() =>
                      handleCopyAddress("token", "XLTMy69uUrDzWBa9JX1xq")
                    }
              ...
              <div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <button
                    onClick={() =>
                      handleCopyAddress("wallet", "wallet-address")
                    }
                    className="text-gray-400 hover:text-gray-600"
                  >
                    <Copy className="w-4 h-4" />
